...
import { Box, Button, Flex, Text, useModal } from '@pyroswap/uikit'
...
const Contribute: React.FC<ContributeProps> = ({
  ...
  const handleContributeSuccess = (amount: BigNumber) => {
    toastSuccess('Success!', `You have contributed ${getBalanceNumber(amount)} CAKE-ETH LP tokens to this IFO!`)
