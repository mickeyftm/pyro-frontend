...
import { Flex, TooltipText, IconButton, useModal, CalculateIcon, Skeleton, useTooltip } from '@pyroswap/uikit'
...
const AprRow: React.FC<AprRowProps> = ({ pool, isAutoVault = false, compoundFrequency = 1, performanceFee = 0 }) => {
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s PYRO is compounded automatically, so we show APY.')
